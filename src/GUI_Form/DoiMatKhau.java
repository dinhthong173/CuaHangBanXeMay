        ...
        try {
            ...
            if (rs.next()) {
                if (mkCu.equalsIgnoreCase(pass_i)) {
                    if (mkMoi.equals("")) {
                        JOptionPane.showMessageDialog(null, "Bạn Chưa Nhập Mật Khẩu Mới", "Lỗi", JOptionPane.ERROR_MESSAGE);
                        ...
                        stmt.setString(2, id);
                        stmt.executeUpdate();
                        JOptionPane.showMessageDialog(null, "Mật Khẩu Đã Được Thay Đổi Thành Công", "Thành Công", JOptionPane.INFORMATION_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(null, "Mật Khẩu Cũ Không Đúng,Vui Lòng Thử Lại", "Lỗi", JOptionPane.ERROR_MESSAGE);
                }
