...
public class QuanLyHoaDon extends javax.swing.JPanel {
	...
	private void timKiemHoaDonKH() {
		...
		String maKH = khachhang.get(khSelect).getMaKH();
		if (maKH.equals("")) {
	...
	public void timTheoKH(String maKH) {
		Locale locale = new Locale("vi", "VN");
		NumberFormat fm = NumberFormat.getCurrencyInstance(locale);
		String gethd = "SELECT * FROM HoaDon where maKH='" + maKH + "'";
		Connection conn = ConnectionDB.openConnection();
		Vector col_ct = new Vector();
		data = new Vector();
		int i = 1;
	...
	private void timKiemHoaDonNV() {
		
		int nvSelect = cboNV.getSelectedIndex();
		String manv = nhanvien.get(nvSelect).getMaNV();
		if (manv.equals("")) {
	...
	public void timTheoNV(String maNV) {
		Locale locale = new Locale("vi", "VN");
		NumberFormat fm = NumberFormat.getCurrencyInstance(locale);
		String gethd = "SELECT * FROM HoaDon where maNV='" + maNV + "'";
		Connection conn = ConnectionDB.openConnection();
		Vector col_ct = new Vector();
		data = new Vector();
		int i = 1;
