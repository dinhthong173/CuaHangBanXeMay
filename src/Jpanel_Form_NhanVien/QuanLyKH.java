...
public class QuanLyKH extends javax.swing.JPanel {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
		...
		Date namSinh = jDateChooser1.getDate();
		String namSinh_input = new SimpleDateFormat("yyyy-MM-dd").format(namSinh);
		String email = txtEmail.getText();
		String soDT = txtSoDT.getText();
		String dc = txtDiaChi.getText();
		if (ho_Ten.equals("") || cmnd.equals("") || namSinh.equals("") || email.equals("") || soDT.equals("")
				|| dc.equals("")) {
			JOptionPane.showMessageDialog(btnXoa, "Hãy nhập đầy đủ thông tin", "LỖI!!!", JOptionPane.ERROR_MESSAGE);
			check = false;
		} else {
			if (kiemTraDL()) {
				if (check = true) {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        int row = tblKh.getSelectedRow();
        if(row == -1){
            JOptionPane.showMessageDialog(null,"Chọn khách hàng cần xóa","LỖI",JOptionPane.ERROR_MESSAGE);
            check = false;
        }else if(check = true){
            int click = JOptionPane.showConfirmDialog(null,"Bạn có chắc chắn xóa","THÔNG BÁO",JOptionPane.YES_NO_OPTION);
         //   JOptionPane.showMessageDialog(btnXoa,"Xóa thành công","THÀNH CÔNG",JOptionPane.INFORMATION_MESSAGE);
            if(click==JOptionPane.YES_OPTION){
                kh_md.xoaKhachHang(kh_en.get(row).getMaKH());
                btnXoaTrangActionPerformed(evt);
                getDL();
                JOptionPane.showMessageDialog(null,"Xóa thành công","THÀNH CÔNG",JOptionPane.INFORMATION_MESSAGE,null);
            }
            else if(click==JOptionPane.NO_OPTION) {
            	JOptionPane.showMessageDialog(null,"Xóa thất bại","THẤT BẠI",JOptionPane.INFORMATION_MESSAGE,null);
            }
